...
@section('meta_description', 'Reset password administrator website — Sistem Inventaris Lab RPL SMKN 9 Malang')
    ...
    <div class="flex min-h-screen items-center justify-center p-4">
        <div class="w-full max-w-sm animate-slide-up rounded-2xl border border-gray-100 bg-white p-8 shadow-xl shadow-gray-200/50 dark:border-gray-700 dark:bg-gray-800 dark:shadow-none">
            <div class="space-y-4">
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-4" x-data="{ showPassword: false, showPasswordConf: false, loading: false }" @submit="loading = true">
                    @csrf
